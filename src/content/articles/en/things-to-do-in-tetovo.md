---
title: 'Things to Do in Tetovo'
description: 'What to do in Tetovo, North Macedonia: the Painted Mosque, the Arabati Baba Bektashi tekke, the Kale fortress, Šar Planina and the Popova Šapka mountains.'
slug: 'things-to-do-in-tetovo'
lang: 'en'
category: 'cities'
...
featuredOrder: 4
geo:
  coord: [42.0106, 20.9714]
  address: 'Tetovo, Polog region, North Macedonia'
accessFrom:
  skopje:
    km: 45
    duration: '~45 min by car / under 1 h by bus'
cover:
...
gallery:
  - src: '/images/things-to-do-in-tetovo/painted-mosque-interior.webp'
    ...
    credit: 'Photo: Pudelek (Marcin Szala) · CC BY-SA 3.0 · Wikimedia Commons'
  - src: '/images/things-to-do-in-tetovo/arabati-baba-fountain.webp'
    alt: 'A wooden pavilion over a marble fountain in the courtyard of the Arabati Baba tekke'
    credit: 'Photo: Adam Jones · CC BY-SA 3.0 · Wikimedia Commons'
  - src: '/images/things-to-do-in-tetovo/pena-river.webp'
    alt: 'The Pena River running through the centre of Tetovo past riverside buildings'
    credit: 'Photo: Aktron (Karel Jakubec) · CC BY 4.0 · Wikimedia Commons'
  - src: '/images/things-to-do-in-tetovo/shar-alpine-lake.webp'
    alt: 'A glacial alpine lake high in the Šar Planina range, one of the "eyes of Šar"'
    credit: 'Photo: Shehadin · CC0 · Wikimedia Commons'
affiliate:
  - partner: 'trip-hotels'
    label: 'Where to stay in Tetovo'
    position: 'body-end'
  - partner: 'trip-tours'
    label: 'Tours & day trips from Tetovo'
    position: 'body-end'
sources:
  - 'Šarena Mosque (Painted / Colourful / Aladža Mosque), Tetovo — originally built 1438; reconstructed 1833 by Abdurrahman Pasha with painters from Debar; financed by two local sisters, Hurshida and Mensure, whose tombs are in the courtyard türbe; over 30,000 eggs reportedly used to prepare the paint and glaze — en.wikipedia.org/wiki/Šarena_Mosque.'
  - 'Arabati Baba Teḱe — Bektashi dervish lodge originally built 1538 around the türbe of Sersem Ali Baba; current grounds endowed via a 1799 waqf of Recep Pasha; one of the finest surviving Bektashi monasteries in Europe; appears on Tetovo''s coat of arms — en.wikipedia.org/wiki/Arabati_Baba_Teḱe.'
  - 'Tetovo Fortress (Kale / Baltepe) — built from 1820 under Abdurrahman Pasha on Baltepe hill above the town; fell into ruin after 1843; ruined fortress open to the public, restoration work 2008–2012 — en.wikipedia.org/wiki/Tetovo_Fortress.'
  - 'Tetovo — Polog Statistical Region, on the foothills of Šar Mountain, divided by the Pena River; majority-Albanian, multi-ethnic; per 2021 census the city had 63,176 people (Albanians 65.5%, Macedonians 22.3%) — en.wikipedia.org/wiki/Tetovo.'
  - 'South East European University (SEEU) — established 2001, officially opened 20 November 2001 on the initiative of OSCE High Commissioner Max van der Stoel; trilingual (Albanian, Macedonian, English) — en.wikipedia.org/wiki/South_East_European_University. State University of Tetova founded 1994, legalised by parliament 2004 — en.wikipedia.org/wiki/State_University_of_Tetova.'
  - 'Šar Planina National Park — declared by the Assembly of North Macedonia on 30 June 2021, the country''s fourth national park; ~627 km²; highest peak Titov Vrv 2,748 m, about 21 km NW of Tetovo near the Kosovo border — en.wikipedia.org/wiki/Šar_Planina_National_Park, en.wikipedia.org/wiki/Šar_Mountains.'
  - 'Popova Šapka — ski resort / mountain station above Tetovo, base ~1,700 m, ~18 km from Tetovo; old gondola from Tetovo out of service since 2001 — skiresort.info/ski-resort/popova-sapka, popovashapka.mk.'
  - 'Skopje–Tetovo ~42–45 km, ~40–45 min by road, frequent buses; Tetovo→Mavrovo NP ~60 km (~1 h) via Gostivar — rome2rio.com/Bus/Skopje/Tetovo, rome2rio.com/s/Tetovo/Mavrovo.'
draft: false
---
...
<figure class="figure">
<img src="/images/things-to-do-in-tetovo/painted-mosque.webp" alt="The Painted Mosque of Tetovo, its facade covered in hand-painted geometric and floral panels, with a tall minaret" width="1280" height="750" loading="lazy" decoding="async" />
<figcaption>The Šarena Džamija — Tetovo's Painted Mosque, decorated in oil paint rather than the usual Ottoman tiles. <span class="figure__credit">Photo: Делфина · CC BY-SA 4.0 · Wikimedia Commons</span></figcaption>
</figure>
...
<figure class="figure">
<img src="/images/things-to-do-in-tetovo/arabati-baba-tekke.webp" alt="The garden courtyard of the Arabati Baba tekke with wooden lodge buildings and a tall tower among trees" width="1280" height="960" loading="lazy" decoding="async" />
<figcaption>The Arabati Baba tekke — a Bektashi dervish lodge set in quiet gardens. <span class="figure__credit">Photo: Vaurien · CC BY-SA 3.0 · Wikimedia Commons</span></figcaption>
</figure>
...
<figure class="figure">
<img src="/images/things-to-do-in-tetovo/kale-fortress.webp" alt="A surviving stone arched gateway in the ruined walls of the Kale fortress above Tetovo" width="880" height="660" loading="lazy" decoding="async" />
<figcaption>A surviving arched gateway in the ruined Kale (Baltepe) fortress above Tetovo. <span class="figure__credit">Photo: Делфина · CC BY-SA 4.0 · Wikimedia Commons</span></figcaption>
</figure>
...
<figure class="figure">
<img src="/images/things-to-do-in-tetovo/seeu-campus.webp" alt="The low modern buildings and landscaped paths of the South East European University campus in Tetovo" width="1280" height="960" loading="lazy" decoding="async" />
<figcaption>The South East European University campus — a modern, trilingual university that gives Tetovo a youthful buzz. <span class="figure__credit">Photo: Liridon · CC BY-SA 4.0 · Wikimedia Commons</span></figcaption>
</figure>
...
<figure class="figure">
<img src="/images/things-to-do-in-tetovo/shar-planina-peaks.webp" alt="The rocky high peaks of the Šar Planina range under a blue sky" width="1280" height="960" loading="lazy" decoding="async" />
<figcaption>The rocky high peaks of Šar Planina, now a national park, rising above Tetovo. <span class="figure__credit">Photo: Делфина · CC BY-SA 4.0 · Wikimedia Commons</span></figcaption>
</figure>
...
<figure class="figure">
<img src="/images/things-to-do-in-tetovo/popova-sapka.webp" alt="A snowy mountain road and ski-lift pylon at Popova Šapka in winter, looking down toward the valley" width="1280" height="853" loading="lazy" decoding="async" />
...
**From Skopje.** Tetovo is only about **45 km west of the capital — roughly 40–45 minutes by car** on the motorway, and **under an hour by bus**. Buses run very frequently through the day, which makes Tetovo one of the easiest day trips from Skopje; a rental car gives you the freedom to carry on up to Popova Šapka or toward Mavrovo. See our [getting around North Macedonia](/transport/getting-around-north-macedonia/) guide for buses and the [car rental](/car-rental/renting-a-car-in-north-macedonia/) guide for self-driving.
...
- **Visas & entry:** US, UK, EU and Ukrainian citizens travel visa-free for 90 days within any 180; **Russian citizens need a visa** (since 21 March 2022). Rules change — always confirm with an official source. More in our [North Macedonia planning hub](/planning/).

## Read also

- Browse all [cities of North Macedonia](/cities/)
- The capital next door: [things to do in Skopje](/cities/things-to-do-in-skopje/)
- Plan the budget: [North Macedonia trip cost](/planning/north-macedonia-trip-cost/)
- Where else to go: [things to do in Bitola](/cities/things-to-do-in-bitola/)
- The classic [7-day North Macedonia route](/routes/north-macedonia-7-day-itinerary/)
