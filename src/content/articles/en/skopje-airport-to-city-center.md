---
title: 'How to Get from Skopje Airport to the City Center'
description: 'Skopje Airport to the city center by shuttle bus, taxi or transfer: the 199 MKD Erak bus, fixed-fare airport taxis, times, costs and denar-cash tips.'
slug: 'skopje-airport-to-city-center'
lang: 'en'
category: 'transport'
...
yearInTitle: false
cover:
  src: '/images/skopje-airport-to-city-center/cover.webp'
  alt: 'The terminal building of Skopje International Airport with its Macedonian-language sign'
coverCredit: 'Photo: Stas Kozlovskiy · CC BY-SA 4.0 · Wikimedia Commons'
gallery:
  - src: '/images/skopje-airport-to-city-center/g4-skopje-centre.webp'
...
affiliate:
  ...
  - partner: 'localrent'
    ...
    position: 'body-end'
sources:
  - 'Checked 2026-06-29: Skopje International Airport official passenger guide — to/from the airport by bus (skp.airports.com.mk). Operator ERAK TRANSPORTER DOOEL; one-way ticket 199 MKD; service runs 08:00–20:00; the timetable is set to match flight arrivals and departures.'
  - 'Checked 2026-06-29: Erak Transporter shuttle (eraktransporter.com) — airport shuttle stops at key bus stops across Skopje, with the route commonly listed as Capitol Mall, the Transportation Center (intercity bus + railway station) and the city centre near the Holiday Inn.'
  - 'Checked 2026-06-29: Welcome Pickups / public Skopje airport guides — Skopje International Airport (SKP) is in Petrovec, roughly 20–23 km southeast of the centre; airport taxis run on a published fixed fare to the city, commonly quoted around 1,200–1,500 MKD (about €20–25); a road transfer takes about 20–30 minutes outside rush hour. Prices change, so confirm before you travel.'
  - 'Macedonian denar (MKD) — de facto pegged to the euro, central rate ~61.5 MKD/EUR (≈61.5 to €1).'
  - 'Image source: cover — File:Skopje aeroport.jpg, Stas Kozlovskiy, CC BY-SA 4.0, Wikimedia Commons, https://commons.wikimedia.org/wiki/File:Skopje_aeroport.jpg'
  - 'Image source: arrivals hall — File:Skopje International Airport, Arrivals, Macedonia (SKP) (50351069678).jpg, Andrew Milligan sumo, CC BY 2.0, Wikimedia Commons, https://commons.wikimedia.org/wiki/File:Skopje_International_Airport,_Arrivals,_Macedonia_(SKP)_(50351069678).jpg'
  - 'Image source: city bus — File:CityLAZ-12 (SK 837-VJ) JSP.jpg, Bálint Sallói, CC BY-SA 4.0, Wikimedia Commons, https://commons.wikimedia.org/wiki/File:CityLAZ-12_(SK_837-VJ)_JSP.jpg'
  - 'Image source: Stone Bridge — File:03 Skopje.jpg, Делфина, CC BY-SA 3.0, Wikimedia Commons, https://commons.wikimedia.org/wiki/File:03_Skopje.jpg'
  - 'Image source: central Skopje — File:04144-Skopje (27869212796).jpg, xiquinhosilva, CC BY 2.0, Wikimedia Commons, https://commons.wikimedia.org/wiki/File:04144-Skopje_(27869212796).jpg'
draft: false
---
...
| **Airport taxi (fixed fare)** | Groups, luggage, after the shuttle stops | ~1,200–1,500 MKD (~€20–25) | ~20–30 min |
| **Private transfer (pre-booked)** | Late flights, door-to-door, first visit | quote per vehicle | ~20–30 min |

If you are arriving in daylight and travelling light, the shuttle is the obvious pick — it is cheap, it goes to the middle of town, and you do not have to talk to anyone. If you land late, have a family in tow, or your hotel is somewhere awkward, the extra money for a taxi or transfer buys you a door-to-door arrival with no waiting. Either way, this is just the first leg; once you have a base in the capital, see [things to do in Skopje](/cities/things-to-do-in-skopje/) for what's around the corner.

<figure class="figure">
<img src="/images/skopje-airport-to-city-center/g1-arrivals-hall.webp" alt="The arrivals area inside Skopje International Airport with shops and waiting passengers" width="1280" height="853" loading="lazy" decoding="async" />
<figcaption>Skopje's terminal is small and easy to read — arrivals, the taxi desk and the shuttle stop are all a short walk apart. <span class="figure__credit">Photo: Andrew Milligan sumo · CC BY 2.0 · Wikimedia Commons</span></figcaption>
</figure>
...
Two practical notes. First, because departures track the flights, there isn't a bus every fifteen minutes — if you just missed one, the wait can be long, and that is exactly when people give up and take a taxi. Second, if your onward plan is the lake, the **Transportation Center** stop is the one you want: that is where the [intercity coaches to Ohrid and Bitola](/transport/getting-around-north-macedonia/) leave from, so you can roll off the shuttle and onto a long-distance bus without crossing town.

<figure class="figure">
<img src="/images/skopje-airport-to-city-center/g2-jsp-bus.webp" alt="A red Skopje city bus waiting at a stop in the city centre" width="1280" height="959" loading="lazy" decoding="async" />
<figcaption>Once you're in town, Skopje runs on JSP city buses and cheap taxis — there is no metro or tram. <span class="figure__credit">Photo: Bálint Sallói · CC BY-SA 4.0 · Wikimedia Commons</span></figcaption>
</figure>
...
If your first night is actually in **Ohrid** rather than Skopje, a transfer matters even more, because there is **no direct bus from the airport to the lake** — you'd otherwise shuttle into Skopje and change to a coach. Our guide on [how to get to Ohrid from Skopje](/transport/how-to-get-to-ohrid-from-skopje/) lays out that connection in full.
...
<figure class="figure">
<img src="/images/skopje-airport-to-city-center/g3-stone-bridge.webp" alt="The Stone Bridge over the Vardar river in central Skopje" width="1280" height="960" loading="lazy" decoding="async" />
<figcaption>The Stone Bridge and the Vardar mark the centre of Skopje — most arrivals are walking distance from here. <span class="figure__credit">Photo: Делфина · CC BY-SA 3.0 · Wikimedia Commons</span></figcaption>
</figure>
...
- [Things to do in Skopje](/cities/things-to-do-in-skopje/) — what to see once you've dropped your bags
- [Getting around North Macedonia](/transport/getting-around-north-macedonia/) — buses, taxis and the wider transport picture
- [How to get to Ohrid from Skopje](/transport/how-to-get-to-ohrid-from-skopje/) — the onward connection to the lake
- [Renting a car in North Macedonia](/car-rental/renting-a-car-in-north-macedonia/) — if you're collecting wheels at the airport
