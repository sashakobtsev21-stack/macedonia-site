---
title: 'Getting Around North Macedonia: Buses, Taxis and Transfers'
description: 'How to get around North Macedonia: intercity buses from Skopje, city buses, taxis and transfers, car hire and the airports — with denar-cash tips.'
slug: 'getting-around-north-macedonia'
lang: 'en'
category: 'transport'
...
featuredOrder: 2
cover:
  src: '/images/getting-around-north-macedonia/cover.webp'
  alt: 'A red double-decker city bus on a street in central Skopje'
coverCredit: 'Photo: Avi1111 dr. avishai teicher · CC BY-SA 4.0 · Wikimedia Commons'
gallery:
  - src: '/images/getting-around-north-macedonia/g4-city-bus.webp'
...
affiliate:
  ...
  - partner: 'car-rental'
    ...
    position: 'body-end'
  - partner: 'trip-tours'
    label: 'Day tours and excursions from Skopje and Ohrid'
    position: 'body-end'
sources:
  - 'Železnici na Republika Severna Makedonija (MŽ) — passenger network: Skopje–Bitola via Veles/Prilep runs a sparse daily service; no railway reaches Ohrid; Skopje–Kičevo (via Tetovo) passenger service long suspended. International Skopje–Belgrade / Skopje–Thessaloniki trains suspended (construction on the Niš–Preševo line).'
  - 'Skopska Avtobuska Stanica (SAS, sas.com.mk) — main intercity bus station, part of the Transportation Center Skopje shared with the railway station.'
  - 'Road distances / typical bus durations: Skopje–Ohrid ~170 km road, ~3–3.5 h; Skopje–Bitola ~170 km, ~3–3.5 h; Skopje–Tetovo ~45 km, under 1 h (Rome2rio, Balkanviator).'
  - 'Skopje International Airport (SKP) — Petrovec municipality, roughly 20–23 km southeast of the centre; airport shuttle bus and fixed-fare airport taxis (skp.airports.com.mk).'
  - 'Ohrid St. Paul the Apostle Airport (OHD) — about 9–10 km from Ohrid near Struga; seasonal, busiest in summer (ohd.airports.com.mk).'
  - 'JSP Skopje (Javno Soobraćajno Pretprijatie) — operator of Skopje city buses, including red double-deckers; bus-only, no metro or tram.'
  - 'Macedonian denar (MKD) — de facto pegged to the euro, central rate ~61.5 MKD/EUR.'
draft: false
---
...
So treat the train as a curiosity, not a plan. The backbone of getting around is the bus, with a car for everything off the main corridors. If your trip is built around the lake and the mountains, read our [car rental in North Macedonia](/car-rental/renting-a-car-in-north-macedonia/) guide alongside this one — the two together cover every way of moving.
...
<figure class="figure">
<img src="/images/getting-around-north-macedonia/g1-bus-station.webp" alt="The modern bus and railway transport centre building in Skopje" width="1280" height="960" loading="lazy" decoding="async" />
<figcaption>Skopje's main bus station (SAS) shares the Transportation Center with the railway station — the hub for nearly every intercity route. <span class="figure__credit">Photo: METOKARA · CC BY-SA 3.0 · Wikimedia Commons</span></figcaption>
</figure>
...
<figure class="figure">
<img src="/images/getting-around-north-macedonia/g4-city-bus.webp" alt="A red JSP city bus on a street in central Skopje" width="1280" height="960" loading="lazy" decoding="async" />
<figcaption>JSP runs Skopje's city buses, including the red double-deckers — the backbone of getting around the capital. <span class="figure__credit">Photo: Robot8A · CC BY-SA 4.0 · Wikimedia Commons</span></figcaption>
</figure>
...
<figure class="figure">
<img src="/images/getting-around-north-macedonia/g2-skp-airport.webp" alt="The passenger terminal building at Skopje International Airport" width="1280" height="822" loading="lazy" decoding="async" />
<figcaption>Skopje International Airport (SKP) is about 20–23 km southeast of the centre — reached by shuttle bus, fixed-fare taxi or a pre-booked transfer. <span class="figure__credit">Photo: LazialeStojakovo · CC BY-SA 3.0 · Wikimedia Commons</span></figcaption>
</figure>
...
<figure class="figure">
<img src="/images/getting-around-north-macedonia/g3-ohrid-road.webp" alt="A road curving above the blue water of Lake Ohrid in Galičica National Park" width="1600" height="533" loading="lazy" decoding="async" />
<figcaption>The road above Lake Ohrid through Galičica National Park — the kind of scenery the buses skip and a car delivers. <span class="figure__credit">Photo: Tomasz Lewicki · CC BY-SA 2.0 · Wikimedia Commons</span></figcaption>
</figure>
...
- Plan the trip: [is North Macedonia worth visiting?](/planning/is-north-macedonia-worth-visiting/)
