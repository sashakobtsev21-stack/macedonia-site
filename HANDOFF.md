...
**Дата:** 2026-06-22 · **Этап:** контент-наполнение (Неделя 1–3 KALENDAR) — опубликованы статьи Скопье (столица), Охрид (якорь), Битола (город), **маршрут 7-Day Itinerary** и первые 2 новости. **Сайт переведён на один язык — только английский (en); ru/uk удалены.** Витрина главной: 3 города + маршрут → `qa` = **GO**.
